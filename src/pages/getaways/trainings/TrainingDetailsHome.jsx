...
const TrainingDetailsHome = () => {
  // Add state for Read More functionality
  const [expanded, setExpanded] = useState(false);
 
  // Full content text
  const fullContent = `Our training programs are designed to help you improve your cycling skills and fitness level.
    Whether you're a beginner looking to build confidence on the bike or an experienced rider
    aiming to enhance your performance, our expert coaches will guide you through personalized
    training sessions.
   
    Each program includes technique workshops, endurance building, and performance assessment
    to ensure you make progress towards your cycling goals. Join us for a transformative
    training experience that will take your riding to the next level.`;
 
  // Shortened content for collapsed view
  const shortContent = `Our training programs are designed to help you improve your cycling skills and fitness level.
    Whether you're a beginner looking to build confidence on the bike or an experienced rider
    aiming to enhance your performance, our expert coaches will guide you through personalized
    training sessions...`;
...
export default TrainingDetailsHome;
